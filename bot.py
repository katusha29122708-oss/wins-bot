...
def classify_message(text):
    result = ai(
        ...
        "struggle — ТОЛЬКО если человек пишет что ничего не делал, день пустой, без единого действия. "
...
def reframe_win(text):
    result = ai(
        ...
        "Переформулируй каждое как тёплую победу — одно предложение на каждое действие. "
