...
def reframe_win(text):
    system = (
        ...
        "Переформулируй каждое как тёплую победу — одно короткое предложение на каждое действие. "
        "Если действий несколько — перечисли через новую строку, каждое начинается с символа bullet. "
        "Без пафоса, без слов молодец и браво. Только на русском языке, никаких иероглифов и символов других языков."
    )
